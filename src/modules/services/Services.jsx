...
import { getServices, getServiceVariations,getServiceCategories } from '../../apis/services';
...
const Services = () => {
    ...
    const loadServiceCategories = async () => {
        try {
            ...
            setServiceCategories(res.data.data.map((e) => { return { value: e.id, name: e.category_title } }));
        } catch (error) {
